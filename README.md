...
tailored regex copula/SPO extractor, not a general semantic parser; see
[Positioning & prior art](#positioning--prior-art) for how it is scoped and what
it is not.
...
```sh
pip install "loomground-factual @ git+https://github.com/flxk1/loomground-factual@<commit>"
```

## Licence

Apache-2.0. See [`LICENSES/Apache-2.0.txt`](LICENSES/Apache-2.0.txt) and
[`NOTICE`](NOTICE).
